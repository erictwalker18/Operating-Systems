...
// functions for the 2 types of threads, one that produces oxygen and one hydrogen
void* Oxygen(void* args);
void* Hydrogen(void* args);

// function that does N^2 ops - used to introduce randomness in the running order of threads
void delay(int);
...
int main() {
  ...
  // create 6 threads, 4 running the Hydrogen function and 2 running the Oxygen function
